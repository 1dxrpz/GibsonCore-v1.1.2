...
namespace PerlinNoise {
    ...
    ///   <para>(1) Generate a white noise field</para>
    ///   <para>(2) Smooth that field using the PerlinNoiseField method.</para>
    ///   <para>(3) Optionally apply filters and/or transformers to the field.</para>
    /// </summary>
